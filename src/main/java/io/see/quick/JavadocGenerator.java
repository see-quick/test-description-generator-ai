...
public class JavadocGenerator {
    ...
    private static String generateDocumentation(final MethodDeclaration methodDeclaration, final String authorOfMethod,
        ...
        final String prompt = "Generate a Java annotation using the `@TestDoc` format based on the provided method signature and EBNF grammar. " +
            ...
            "Include author as @Contact!: name: " + authorOfMethod + " with email: " + authorsEmailMethod + "\n" +
    ...
    private static String generateDocumentationForSuite(final ClassOrInterfaceDeclaration classOrInterfaceDeclaration, final String authorOfClass,
        ...
        final String prompt = "Generate a Java annotation using the `@SuiteDoc` format based on the provided class signature and EBNF grammar. " +
            ...
            "Include author as @Contact!: name: " + authorOfClass + " with email: " + authorsEmailClass + "\n" +
    ...
    private static class ClassVisitor extends VoidVisitorAdapter<Void> {
        ...
        public void visit(ClassOrInterfaceDeclaration classOrInterfaceDeclaration, Void arg) {
            ...
            System.out.println("Author of class " + classOrInterfaceDeclaration.getName() + ": " + authorDetails[0] + " with email: " + authorDetails[1]);
    ...
    private static class MethodVisitor extends VoidVisitorAdapter<Void> {
        ...
        public void visit(MethodDeclaration methodDeclaration, Void arg) {
            if (isTestMethod(methodDeclaration)) {
                ...
                // Now use the author info to modify the @Contact annotation
                System.out.println("Author of method " + methodDeclaration.getName() + ": " + authorDetails[0] + " with email: " + authorDetails[1]);
