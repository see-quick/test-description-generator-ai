...
@SuiteDoc(
    ...
    beforeTestSteps = {
        @Step(value = "Assume false for OLM or Helm install and true for Kafka Node Pools enabled. Run cluster operator installation.", expected = "Cluster operator is installed")
    },
    afterTestSteps = {
